...
export default function App() {
  ...
  const initPixi = () => {
    ...
    const displacementFilter = new window.PIXI.filters.DisplacementFilter(waterSprite);
    ...
    app.ticker.add((delta) => {
      ...
      for (let i = drops.length - 1; i >= 0; i--) {
        ...
        // drop.sprite.alpha = Math.max(3 - (depthRatio * 4), 0);
        ...
        if (drop.life - drop.lastTrailTime > (15 - depthRatio * 10)) {
          ...
          const trailBlur = new window.PIXI.filters.BlurFilter();
